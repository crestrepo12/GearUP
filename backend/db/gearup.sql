...
INSERT INTO clients (firstname, lastname, email, age, occupation, gender, residential_address, zipcode, phone_number, imgurl, bio, disability, medicaid, provider_id) 
  ...
  ('Bale', 'Pinnocke', 'bpinnockea@amazon.co.uk', 23, 'Automation Specialist', 'Male', '2622 Lunder Trail, NYC, NY', '10019', '240-858-0789', '../../assets/adult-blurred-background-boy-719734.jpg', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', DEFAULT, 1),
