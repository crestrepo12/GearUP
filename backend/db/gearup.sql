...
INSERT INTO providers (firstname, lastname, email, password_digest, occupation, gender, bio, zipcode, phone_number, imgurl)
  VALUES
  ('carol', 'rest', 'ca@mail.com', '$2a$10$kjH6HiZmn9y4jABk9PN3v.rHJ51RJWGo5nYPZba16hIX4YUr9CVjS', 'MSW', 'Female', '12 years in Social Work, helping clients become more dependent on themselves and financially independent', '11215', '696-453-1121', 'http://flaticons.net/gd/makefg.php?i=icons/People/provider.png&r=255&g=255&b=255'),
  ('mike', 'mcd', 'mcdonald@mail.com', '$2a$10$kjH6HiZmn9y4jABk9PN3v.rHJ51RJWGo5nYPZba16hIX4YUr9CVjS', 'MSW', 'Male', '7 years in Social Work, helping clients become more dependent on themselves and financially independent', '10019', '696-425-1346','http://flaticons.net/gd/makefg.php?i=icons/People/provider.png&r=255&g=255&b=255');
...
INSERT INTO clients (firstname, lastname, email, age, occupation, gender, residential_address, zipcode, phone_number, imgurl, bio, disability, medicaid, provider_id) 
  ...
  ('Krishnah', 'Luten', 'kluten6@weibo.com', 21, 'Chief Design Engineer', 'Male', '403 Waywood Alley, NYC, NY', '10019', '936-316-0710', 'http://flaticons.net/gd/makefg.php?i=icons/People/provider.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', true, 1),
  ('Ardys', 'Grigorushkin', 'agrigorushkin7@unesco.org', 20, 'Computer Systems Analyst II', 'Female', '23796 Fulton Avenue, NYC, NY', '10019', '635-445-2226', 'http://flaticons.net/gd/makefg.php?i=icons/People/provider.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', false, 2),
  ('Ulla', 'Been', 'ubeen8@moonfruit.com', 30, 'Registered Nurse', 'Female', '57181 Independence Lane, NYC, NY', '10019', '807-382-9031', 'http://flaticons.net/gd/makefg.php?i=icons/People/provider.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', false, 1),
  ('Shani', 'Gostridge', 'sgostridge9@illinois.edu', 25, 'Software Consultant', 'Female', '2481 Menomonie Plaza, NYC, NY', '10019', '773-342-0963', 'http://flaticons.net/gd/makefg.php?i=icons/People/provider.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', true, 2),
  ('Bale', 'Pinnocke', 'bpinnockea@amazon.co.uk', 23, 'Automation Specialist I', 'Male', '2622 Lunder Trail, NYC, NY', '10019', '240-858-0789', 'http://flaticons.net/gd/makefg.php?i=icons/People/provider.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', false, 1),
  ('Jinny', 'Zupa', 'jzupab@dagondesign.com', 15, 'Paralegal', 'Female', '98 Roxbury Court, NYC, NY', '10019', '140-219-9592', 'http://flaticons.net/gd/makefg.php?i=icons/People/provider.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', true, 2);
