...
INSERT INTO clients (firstname, lastname, email, age, occupation, gender, residential_address, zipcode, phone_number, imgurl, bio, disability, medicaid) 
  VALUES 
  ...
  ('Camella', 'Antrobus', 'cantrobus1@noaa.gov', 27, 'Graphic Designer', 'Female', '2 Helena Junction, NYC, NY', '10019', '268-109-7437', 'http://flaticons.net/gd/makefg.php?i=icons/People/Employee.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', true),
  ('Blondie', 'Andreaccio', 'bandreaccio2@pbs.org', 27, 'Quality Control Specialist', 'Female', '6 Stephen Place, NYC, NY', '10019', '239-270-6423', 'http://flaticons.net/gd/makefg.php?i=icons/People/Employee.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', false),
  ('Shaine', 'Carrol', 'scarrol3@tumblr.com', 15, 'Automation Specialist II', 'Male', '470 Twin Pines Circle, NYC, NY', '10019', '583-929-9660', 'http://flaticons.net/gd/makefg.php?i=icons/People/Employee.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', false),
  ...
  ('Bale', 'Pinnocke', 'bpinnockea@amazon.co.uk', 23, 'Automation Specialist I', 'Male', '2622 Lunder Trail, NYC, NY', '10019', '240-858-0789', 'http://flaticons.net/gd/makefg.php?i=icons/People/Employee.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', false),
  ('Jinny', 'Zupa', 'jzupab@dagondesign.com', 15, 'Paralegal', 'Female', '98 Roxbury Court, NYC, NY', '10019', '140-219-9592', 'http://flaticons.net/gd/makefg.php?i=icons/People/Employee.png&r=255&g=255&b=255', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', true);
