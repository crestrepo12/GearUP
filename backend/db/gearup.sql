...
INSERT INTO clients (firstname, lastname, email, age, occupation, gender, residential_address, zipcode, phone_number, imgurl, bio, disability, medicaid, provider_id) 
  VALUES 
  ('Chadd', 'Lepere', 'clepere0@webnode.com', 12, 'Student', 'Male', '64393 Gateway Hill, NYC, NY', '10019', '681-833-4858', 'https://cdn.pixabay.com/photo/2017/10/12/10/41/child-2844209_1280.jpg', 'Hello my name is _______, I come from _________. When I grow up, I would like to be a ________________.', 'autism spectrum', DEFAULT, 1),
